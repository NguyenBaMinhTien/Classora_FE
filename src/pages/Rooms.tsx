...
import { Search, Plus, MapPin, Users, Monitor, Wind, Trash2, Edit2 } from 'lucide-react';
import { motion } from 'motion/react';

const rooms = [
  { id: '1', name: 'B-102', type: 'Phòng Lý thuyết', capacity: 60, building: 'Nhà B', status: 'Đang sử dụng', facilities: ['Máy chiếu', 'Điều hòa'] },
  { id: '2', name: 'LAB-04', type: 'Phòng Thực hành', capacity: 40, building: 'Nhà C', status: 'Trống', facilities: ['Máy tính', 'Điều hòa', 'Internet'] },
  { id: '3', name: 'C-205', type: 'Phòng Lý thuyết', capacity: 80, building: 'Nhà C', status: 'Đang sử dụng', facilities: ['Máy chiếu', 'Âm thanh'] },
  { id: '4', name: 'A-301', type: 'Hội trường', capacity: 200, building: 'Nhà A', status: 'Bảo trì', facilities: ['Sân khấu', 'Hệ thống âm thanh', 'Điều hòa'] },
  { id: '5', name: 'D-101', type: 'Phòng Lý thuyết', capacity: 45, building: 'Nhà D', status: 'Trống', facilities: ['Bảng tương tác'] },
];
                ...
                >
                  <td className="px-10 py-8">
                    <div className="flex items-center gap-4">
                      <div className="bg-slate-100 border border-slate-200 rounded-xl px-3 py-2 text-[11px] font-black text-slate-700 flex flex-col items-center leading-tight shadow-sm group-hover:bg-white transition-colors">
                        <span className="opacity-50">{room.name.split('-')[0]}-</span>
                  ...
                  <td className="px-10 py-8">
                    <span className={`inline-flex items-center gap-2 py-2 px-5 rounded-full text-[10px] font-black uppercase tracking-wider border transition-all ${
                      room.status === 'Trống' 
                      ...
                      <span className={`w-2 h-2 rounded-full ${
                        room.status === 'Trống' ? 'bg-emerald-600 animate-pulse' : 
